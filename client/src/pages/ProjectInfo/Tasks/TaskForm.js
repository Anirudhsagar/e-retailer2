...
function TaskForm({
  ...
  //     (member) =>
  //       member.role ===
  //       "pr, admin, video editor, editor, anchor, digital marketing, social media manager, editor in chief, script writer"
  //   );
  ...
  // const validateEmail = ({ project, email }) => {
  ...
  //   const employeesInProject = members.filter((member) =>
  //     validRoles.includes(member.role)
  //   );

  //   const isEmailValid = employeesInProject.find(
  //     (validRoles) => validRoles.user.email === email
  //   );
